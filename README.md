...
- [ ] Explain what a token is used for. Security and Authentication. Allows you to keep data away from users who do not have a token.
- [ ] What steps can you take in your web apps to keep your data secure? Impliment private routes and impliment token authorization
- [ ] Describe how web servers work. Processes requests over HTTP, stores delivers web pages for clients.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
Create = PUT requests and POST requests, put can create and update depending on the URI used with the put
Read = GET REQUESTS
Update = PUT requests 
